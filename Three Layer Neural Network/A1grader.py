...
if run_my_solution:
    ...
    with open('notebookcode.py', 'w') as outputFile:
        subprocess.call(['jupyter', 'nbconvert', '--to', 'script', nb_name.format(assignmentNumber), '--stdout'],
                        stdout=outputFile, shell=True)
...
try:
    ...
    if all(close):
        ...
        print(
            '\nCorrect values are:\n a_answer={}\n b_answer={}\n c_answer={}\n Zu_answer={}\n Zv_answer={}\n Y_answer={}'.format(
                a_answer, b_answer, c_answer, Zu_answer, Zv_answer, Y_answer))
...
try:
    ...
    if all(close):
        ...
        # print(f'Your values are \n {d3=}\n {d2=}\n {d1=}\n {grad_wrt_U=}\n {grad_wrt_V=}\n {grad_wrt_W=}')
        print(
            '\nCorrect values are:\n d3_answer={}\n d2_answer={}\n d1_answer={}\n grad_wrt_U_answer={}\n grad_wrt_V_answer={}\n grad_wrt_W_answer={}'.format(
                d3_answer, d2_answer, d1_answer, grad_wrt_U_answer, grad_wrt_V_answer, grad_wrt_W_answer))
        print('Your values are \n d3={}\n d2={}\n d1={}\n grad_wrt_U={}\n grad_wrt_V={}\n grad_wrt_W={}'.format(d3, d2,
                                                                                                                d1,
                                                                                                                grad_wrt_U,
                                                                                                                grad_wrt_V,
                                                                                                                grad_wrt_W))
...
try:
    ...
    if rmse_min > 20 and rmse_max < 60:
        ...
        print('\n--0  0/{} points.  Range of RMSE results should be between 20 and 60.  Yours are from {} to {}'.format(
            pts, rmse_min, rmse_max))
